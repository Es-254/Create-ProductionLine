...
| Artifact / 产物 | `build/libs/create_productionline-1.0.1.jar`, also downloadable from [Modrinth](https://modrinth.com/project/createproductionline) or the [Releases](https://github.com/Es-254/Create-ProductionLine/releases) page, and — once the project clears review — from [CurseForge](https://www.curseforge.com/minecraft/mc-mods) (project id 1699977, first file uploaded). Modrinth 与 CurseForge 项目都还在审核中，公开页面待通过后生效 / both listings go live once they pass review. 早期 1.0.0–1.0.3 构建包均为开发快照，已被 1.0.1 取代 (earlier 1.0.0–1.0.3 jars were dev snapshots and are superseded). |
